...
:BUILD
dotnet build "Castle.Transactions.sln" --configuration %CONFIGURATION% --property:BUILD_VERSION=%BUILD_VERSION% --no-restore || EXIT /B 4
...
dotnet test "src\Castle.Services.Transaction.Tests" --no-restore
dotnet test "src\Castle.Facilities.AutoTx.Tests" --no-restore
