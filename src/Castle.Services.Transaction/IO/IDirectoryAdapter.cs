...
namespace Castle.Services.Transaction.IO
{
    ...
    public interface IDirectoryAdapter
    {
        ...
        /// The 'safe' value to get returned for be interopable with other path/directory utility implementations
        /// would hence be <see langword="false" /> (i.e. that the directory didn't already exist).
        /// </remarks>
