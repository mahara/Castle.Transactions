...
namespace Castle.Facilities.AutoTx.Tests
{
    ...
    public class ConfiguredComponentsTests
    {
        ...
        public void IsTransactionalMissing()
        {
            ...
            Assert.That(
                ...
                Throws.TypeOf<FacilityException>()
                      .And.Message.EqualTo("The class 'Castle.Facilities.AutoTx.Tests.TransactionalComponent1' has configured transaction in a child node, but has not specified 'isTransactional=\"true\"' on the component node."));
        }
        ...
        public void HasConfiguration()
        {
            ...
            Assert.That(metaInfo.TransactionalMethods, Has.Count.EqualTo(3));
        }
        ...
        public void ValidConfigForInheritedMethods()
        {
            ...
            Assert.That(metaInfo, Is.Not.Null);
            Assert.That(metaInfo.TransactionalMethods, Has.Count.EqualTo(4));
        }
        ...
        public void ConfigForServiceWithInterface()
        {
            ...
            Assert.That(metaInfo, Is.Not.Null);
            Assert.That(metaInfo.TransactionalMethods, Has.Count.EqualTo(2));
        }
    }
}
