...
namespace Castle.Services.Transaction.Tests
{
    ...
    public class NestedTransactionsTests
    {
        ...
        {
            var root = _transactionManager.CreateTransaction(TransactionScopeOption.Required, IsolationMode.Unspecified);
            Assert.IsTrue(root is TransactionBase);
            root.Begin();

            var child1 = _transactionManager.CreateTransaction(TransactionScopeOption.Required, IsolationMode.Unspecified);
            Assert.IsTrue(child1 is ChildTransaction);
            Assert.IsTrue(child1.IsChildTransaction);
            child1.Begin();

            var child2 = _transactionManager.CreateTransaction(TransactionScopeOption.Required, IsolationMode.Unspecified);
        ...
        public void NestedRequiresAndRequiresNew()
        {
            ...
            var innerRoot = _transactionManager.CreateTransaction(TransactionScopeOption.RequiresNew, IsolationMode.Unspecified);
        ...
        {
            var root = _transactionManager.CreateTransaction(TransactionScopeOption.Suppress, IsolationMode.Unspecified);
            Assert.IsNull(root);
        }
        ...
        public void NotSupportedAndActiveTransaction()
        {
            void Method()
            {
                ...
                _transactionManager.CreateTransaction(TransactionScopeOption.Suppress, IsolationMode.Unspecified);
            }
        ...
        public void SynchronizationsAndCommit_NestedTransaction()
        {
            ...
            var child = _transactionManager.CreateTransaction(TransactionScopeOption.Required, IsolationMode.Unspecified);
