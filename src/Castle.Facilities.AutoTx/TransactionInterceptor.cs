...
namespace Castle.Facilities.AutoTx
{
    ...
    public class TransactionInterceptor : IInterceptor, IOnBehalfAware
    {
        ...
        public void Intercept(IInvocation invocation)
        {
            ...
            try
            {
                if (_metaInfo.ShouldInjectTransactionTo(method))
                {
                ...
                {
                    Logger.Debug($"Rolling back transaction '{transaction.Name}'.");
                ...
                {
                    Logger.Debug($"Committing transaction '{transaction.Name}'.");
            ...
            {
                // Whoops.
                // Special case: let's throw without attempting to rollback anything.
