...
REM ================================================================================
REM BUILD UNIT: Castle.Transactions
REM ================================================================================

SET BUILD_UNIT___Castle.Transactions___BUILD_PARAMETERS=^
    "Castle.Transactions.slnx|%PARAMETER___FRAMEWORKS___DEFAULT%"

SET BUILD_UNIT___Castle.Transactions___TEST_PARAMETERS=^
...
SET BUILD_UNIT___Castle.Transactions___PACKAGE_PARAMETERS=^
...
SET BUILD_UNIT___Castle.Transactions___PACKAGE_NEV_PARAMETERS=^
    "Castle."
